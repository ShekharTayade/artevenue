...
from artevenue.models import Pin_code, Referral, Order
from artevenue.models import User_shipping_address, User_billing_address
from artevenue.models import Profile_group, Egift
...
class contactUsForm(forms.ModelForm):
	...
	class Meta:
		model = Contact_us
		fields = ('first_name', 'last_name', 'email_id', 'phone_number', 'subject', 'message')
