...
class Original_art(models.Model):
	...
	art_surface = models.CharField(max_length = 3, blank=True, default='',
		choices=SURFACE)
	art_surface_desc = models.CharField(max_length = 1000, blank=True, default='')
	category_disp_priority = models.IntegerField(null = True)
...
class Artist_group (models.Model):
	...
	license_fee = models.DecimalField(max_digits=12, decimal_places=2, null=True)
...
class Artist (models.Model):
	...
	show_case_url = models.CharField(max_length = 1000, blank=True, default='')
	default_license_fee = models.DecimalField(max_digits=12, decimal_places=2, null=True)
...
class Artist_art (models.Model):
	...
	product = models.ForeignKey(Product_view, models.PROTECT, null=False)
	product_type = models.ForeignKey(Product_type, on_delete=SET_NULL)
	license_fee = models.DecimalField(max_digits=12, decimal_places=2, null=True)

	def __str__(self):
		return str(self.artist) + self.art_title



class Inventory(models.Model):
	product = models.OneToOneField(Product_view, models.PROTECT, null=False, primary_key=True)
	artist = models.ForeignKey(Artist, models.CASCADE, max_length=10, null=False)
	publisher = models.ForeignKey(Publisher, models.CASCADE, max_length=10, null=True)
...
class Inventory_udate(models.Model):
	product = models.OneToOneField(Product_view, models.PROTECT, null=False)
