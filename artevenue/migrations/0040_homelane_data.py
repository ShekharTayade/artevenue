# Generated by Django 2.2.4 on 2019-08-11 15:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('artevenue', '0039_auto_20190810_1526'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='Homelane_data',
            fields=[
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='artevenue.Stock_image')),
                ...
                ('category_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='artevenue.Stock_image_category')),
