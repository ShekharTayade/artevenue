...
class  User_billing_address (models.Model):
	...
	pin_code_id = models.CharField(max_length=10, blank=False, null=True, default = "NA")
...
class Channel_order_amz(models.Model):
	...
	shipping_pin_code_id = models.CharField(max_length=10, blank=False, null=True, default = "NA")
	...
	billing_pin_code_id = models.CharField(max_length=10, blank=False, null=True, default = "NA")
