...
def checkout_step3_order_review(request):
	...
	usercartitems = Cart_item_view.objects.select_related('product', 
		'promotion').filter(cart = order.cart_id, product__product_type_id = F('product_type_id') ).values(
		...
		'product__url', 'cart_id', 'promotion__discount_value', 'promotion__discount_type', 'mount__color',
		'product__thumbnail_url', 'product__image_to_frame'
		)
	'''
