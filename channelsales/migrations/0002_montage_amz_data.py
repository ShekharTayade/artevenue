# Generated by Django 2.2.4 on 2020-02-26 17:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('channelsales', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='Montage_amz_data',
            fields=[
                ('amazon_key', models.AutoField(primary_key=True, serialize=False)),
                ('amazon_sku', models.CharField(default='', max_length=15, null=True)),
                ...
                ('item_unit_price', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('item_sub_total', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('item_disc_amt', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('item_tax', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ...
                ('parent_child', models.CharField(choices=[('P', 'Parent'), ('C', 'Child')], default='P', max_length=1, null=True)),
                ('parent_amz_sku', models.CharField(default='', max_length=15, null=True)),
