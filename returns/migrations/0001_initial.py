# Generated by Django 2.2.4 on 2021-01-04 09:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ret_reason', models.CharField(blank=True, choices=[('UN', 'Not Specified'), ('Q', 'Quailty Issue'), ('D', 'Damaged Delivery'), ('S', 'Size Issue'), ('N', "Don't Need It"), ('L', 'Did not Like It')], default='', max_length=2)),
        ...
        migrations.CreateModel(
            name='Return_order_user_image',
            fields=[
                ('return_order_item_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='returns.Return_order_item')),
                ('user_image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artevenue.User_image')),
            ],
            bases=('returns.return_order_item',),
        ),
        migrations.CreateModel(
            name='Return_order_stock_image',
            fields=[
                ('return_order_item_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='returns.Return_order_item')),
        ...
        migrations.CreateModel(
            name='Return_order_stock_collage',
            fields=[
                ('return_order_item_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='returns.Return_order_item')),
        ...
        migrations.CreateModel(
            name='Return_order_original_art',
            fields=[
                ('return_order_item_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='returns.Return_order_item')),
